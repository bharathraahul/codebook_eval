...
Designed to plug into PLOVER_Experiments.py on a Chameleon Cloud VM
with Ollama serving gemma2:9b or qwen2.5:7b.

Requirements (install once on VM):
    pip install sentence-transformers faiss-cpu pandas scikit-learn --break-system-packages

Usage as standalone:
    python3 plover_rag.py --step rag_cb          # RAG + codebook chunks
    python3 plover_rag.py --step rag_cb_ex        # RAG + codebook + example retrieval
    python3 plover_rag.py --step rag_noisy        # RAG with noise-robust preprocessing
    python3 plover_rag.py --step table            # Print comparison table
    python3 plover_rag.py --step rag_cb --limit 5 # Quick test on 5 examples

Usage as importable module from PLOVER_Experiments.py:
...
# ---------------------------------------------------------------------------
# Constants (mirrored from PLOVER_Experiments.py for standalone use)
# ---------------------------------------------------------------------------
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 plover_rag.py --step rag_cb --limit 5      # Quick test
    python3 plover_rag.py --step rag_cb                 # Full run, codebook RAG
    python3 plover_rag.py --step rag_cb_ex              # + example retrieval
    python3 plover_rag.py --step rag_noisy              # + noise preprocessing
    python3 plover_rag.py --step table                  # Show results
    python3 plover_rag.py --step demo                   # Interactive demo
        """)
