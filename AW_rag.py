#!/usr/bin/env python3
"""
AW_rag.py — RAG module for A/W binary political event classification

Adapted from PLOVER_rag.py for the A/W dataset (binary: COOPERATION/CONFLICT).

Usage:
    python3 AW_rag.py --step rag_cb
    python3 AW_rag.py --step rag_cb_ex
    python3 AW_rag.py --step rag_noisy
    python3 AW_rag.py --step table
    python3 AW_rag.py --step demo
    python3 AW_rag.py --step rag_cb --limit 5
"""
...
def print_comparison_table():
    ...
    for name, fname in rag_files.items():
        ...
        if os.path.exists(path):
            ...
            print(f"  {name:<25} {'—':>10}")
    print("  " + "-"*35)
    print("  Paper GPT-3.5            76.3")
    print("  Paper GPT-4              87.0")
    print()
